...
export function BlogHeader({ onNavigate, currentView }: BlogHeaderProps) {
  ...
  return (
    <header className="border-b border-gray-200">
      <div className={`max-w-3xl mx-auto px-6 ${isArticleView ? 'py-0' : 'py-12'} ${isArticleView ? 'hidden' : ''}`}>
...
`}
        ...
        <nav className="mt-8 flex gap-2 sm:gap-6">
          <button 
            ...
            className={`${currentView === 'home' ? 'font-bold' : ''} hover:text-gray-900 transition-colors whitespace-nowrap text-xl sm:text-2xl font-bold`}
          ...
          <button 
            ...
            className={`${currentView === 'archives' ? 'font-bold' : ''} hover:text-gray-900 transition-colors whitespace-nowrap text-xl sm:text-2xl font-medium`}
          ...
          <button 
            ...
            className={`${currentView === 'categories' ? 'font-bold' : ''} hover:text-gray-900 transition-colors whitespace-nowrap text-xl sm:text-2xl font-medium`}
          ...
          <button 
            ...
            className={`${currentView === 'tags' ? 'font-bold' : ''} hover:text-gray-900 transition-colors whitespace-nowrap text-xl sm:text-2xl font-medium`}
          ...
          <button 
            ...
            className={`${currentView === 'about' ? 'font-bold' : ''} hover:text-gray-900 transition-colors whitespace-nowrap text-xl sm:text-2xl font-medium`}
